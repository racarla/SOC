...
void hdf5class::WriteData(std::string GroupName,std::string Name,int8_t *data,std::string Attr,size_t rows,size_t columns) {
  H5::Exception::dontPrint();
  ...
  // data set
  H5::DataSet LogDataSet = H5::DataSet(LogGroup.createDataSet(Name.c_str(),H5::PredType::NATIVE_INT8,LogDataSpace));
  ...
  // write data
  LogDataSet.write(data,H5::PredType::NATIVE_INT8);
}

void hdf5class::WriteData(std::string GroupName,std::string Name,int16_t *data,std::string Attr,size_t rows,size_t columns) {
  H5::Exception::dontPrint();
  ...
  // data set
  H5::DataSet LogDataSet = H5::DataSet(LogGroup.createDataSet(Name.c_str(),H5::PredType::NATIVE_INT16,LogDataSpace));
  ...
  // write data
  LogDataSet.write(data,H5::PredType::NATIVE_INT16);
}

void hdf5class::WriteData(std::string GroupName,std::string Name,int32_t *data,std::string Attr,size_t rows,size_t columns) {
  H5::Exception::dontPrint();
  ...
  // data set
  H5::DataSet LogDataSet = H5::DataSet(LogGroup.createDataSet(Name.c_str(),H5::PredType::NATIVE_INT32,LogDataSpace));
  ...
  // write data
  LogDataSet.write(data,H5::PredType::NATIVE_INT32);
}
...
void hdf5class::WriteData(std::string GroupName,std::string Name,uint64_t *data,std::string Attr,size_t rows,size_t columns) {
  H5::Exception::dontPrint();
