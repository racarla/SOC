...
void ExciteMgr::Init()
{
  ...
  if (kConfigSpeed==23) timeStart_s = 1.0; timeOnePulse_s = 0.23; amp_nd = 4 * kD2R; // 23 m/s
  if (kConfigSpeed==17) timeStart_s = 1.0; timeOnePulse_s = 0.27; amp_nd = 4 * kD2R; // 17 m/s
  ...
  if (kConfigSpeed==23) timeStart_s = 1.0; timeOnePulse_s = 0.54; amp_nd = 4 * kD2R; // 23 m/s
  if (kConfigSpeed==17) timeStart_s = 1.0; timeOnePulse_s = 0.72; amp_nd = 4 * kD2R; // 17 m/s
...
ExciteMgrOut ExciteMgr::Compute(const bool& exciteMode, const uint8_t& indxTest, const float& time_s)
{
  exciteMgrOut_.exciteMode = exciteMode;
  exciteMgrOut_.indxTest = indxTest;
  exciteMgrOut_.timeExcite_s = 0.0;
  ...
  if (exciteMode == 1) {
    ...
    exciteMgrOut_.timeExcite_s = time_s - timeEngage_s_;

    switch (indxTest) {
      case 0:
        break;
      case 1:
        cmdExciteTemp = exciteTest01_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[0];
        break;
      case 2:
        cmdExciteTemp = exciteTest02_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 3:
        cmdExciteTemp = exciteTest03_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[0];
        break;
      case 4:
        cmdExciteTemp = exciteTest04_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[1];
        break;
      case 5:
        cmdExciteTemp = exciteTest05_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[1];
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[2];
        break;
      case 6:
        cmdExciteTemp = exciteTest06_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[0];
        break;
      case 7:
        cmdExciteTemp = exciteTest07_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 8:
        cmdExciteTemp = exciteTest08_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[0];
        break;
      case 9:
        cmdExciteTemp = exciteTest09_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[1];
        break;
      case 10:
        cmdExciteTemp = exciteTest10_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[0];
        break;
      case 11:
        cmdExciteTemp = exciteTest11_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 12:
        cmdExciteTemp = exciteTest12_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[0];
        break;
      case 13:
        cmdExciteTemp = exciteTest13_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[0];
        break;
      case 14:
        cmdExciteTemp = exciteTest14_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 15:
        cmdExciteTemp = exciteTest15_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[0];
        break;
      case 16:
        cmdExciteTemp = exciteTest16_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 17:
        cmdExciteTemp = exciteTest17_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[1] = cmdExciteTemp[0];
        break;
      case 18:
        cmdExciteTemp = exciteTest18_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[0] = cmdExciteTemp[0];
        break;
      case 19:
        cmdExciteTemp = exciteTest19_.Compute(exciteMgrOut_.timeExcite_s);
        exciteMgrOut_.cmdExcite[2] = cmdExciteTemp[0];
        break;
